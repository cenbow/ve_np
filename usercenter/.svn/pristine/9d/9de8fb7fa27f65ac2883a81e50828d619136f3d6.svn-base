...
public class SupplierInfoDTO extends BaseDTO implements Serializable {
	...
	public void setTmallWebsite(String tmallWebsite) {
		this.tmallWebsite = tmallWebsite;
	}
	...
	public void setLicenseScanImg(String licenseScanImg) {
		this.licenseScanImg = licenseScanImg;
	}
