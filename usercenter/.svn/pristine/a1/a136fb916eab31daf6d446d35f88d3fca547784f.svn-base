package com.ve.usercenter.core.manager.remote.impl;
...
import com.ve.deliverycenter.common.constant.RegionLevel;
...
public class AddressCheckManagerImpl implements AddressCheckManager {
	...
	@Override
	public ResponseCode addressCheck(ConsigneeDTO consigneeDto)
