...
public class ItemExtraInfoDTO implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -9098131491075279990L;
	...
	public String toString() {
		return "ItemExtraInfoDTO [id=" + id + ", supplierId=" + supplierId + ", itemId=" + itemId + "]";
	}
