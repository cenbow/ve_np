 ...
 * @date 2015年1月21日
 */
public class SkuPropertyTmplDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -700705636906279874L;
	...
	public String toString() {
		return "SkuPropertyTmplDTO [id=" + id + ", keyName=" + keyName + ", val=" + val + "]";
	}
