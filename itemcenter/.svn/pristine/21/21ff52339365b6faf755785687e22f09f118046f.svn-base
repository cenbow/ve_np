...
import com.ve.itemcenter.common.constant.ParamEnum;
import com.ve.itemcenter.core.exception.ItemException;
import com.ve.itemcenter.core.filter.FilterChain;
import com.ve.itemcenter.core.filter.FilterManager;
import com.ve.itemcenter.core.service.action.Action;
import com.ve.itemcenter.core.service.action.ActionHolder;
		...
		public ItemResponse call() {
			...
			if (null != action) {
				...
				if (!allowAccess(appCode, action)) {
					re = new ItemResponse(ErrorCode.BASE_STATE_E_REQUEST_FORBBIDEN);
					return re;
				}
				...
				try {
					...
					res = new ItemResponse(e.getErrorCode(), e.getMessage());
					log.error("do action:" + req.getCommand() + " occur Exception:", e);
					return res;
				} catch (Exception e) {
					res = new ItemResponse(ErrorCode.SYS_E_SERVICE_EXCEPTION);
					log.error("do action:" + req.getCommand() + " occur Exception:", e);
					return res;
				} finally {
				...
				ItemResponse res = new ItemResponse(ErrorCode.BASE_STATE_E_ACTION_NO_EXIST);
				return res;
			}
		}
