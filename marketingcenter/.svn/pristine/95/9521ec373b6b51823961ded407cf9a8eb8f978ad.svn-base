...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws MarketingException{
	...
	private static void setField(Object instance, Field fd, String value) throws MarketingException {
		try {
