...
@Service
public class UpdateToolAction implements Action<MarketingToolDTO> {
	private static final Logger log = LoggerFactory.getLogger(UpdateToolAction.class);
	...
	public String getName() {
		return ActionEnum.TOOL_UPDATE.getActionName();
	}
}
