...
public enum ReturnCodeEnum {
	 ...
	 * 优惠券代码不存在
	 */
	COUPON_CODE_NOT_EXIST("B1001", "coupon code not exist"),
	/**
	 * 优惠券代码已被激活
	 */
	COUPON_CODE_ACTIVATED("B1002", "coupon code has been activated"),
	/**
	 * 活动未发放的优惠券数量不足
	 */
	NO_ENOUGH_COUPON("B1003", "not enough coupon code to granted"),
	/************************************ 系统级别错误 ********************************************/
	/**
	 * 系统错误
	 */
