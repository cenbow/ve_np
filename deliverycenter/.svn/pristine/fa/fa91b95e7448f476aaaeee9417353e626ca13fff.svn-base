...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean)
	...
	private static void setField(Object instance, Field fd, String value)
			throws DeliveryException {
		try {
			if (fd.getType().getCanonicalName().equals("int")) {
			...
			} else if (fd.getType().getCanonicalName()
				...
				throw new IllegalArgumentException(
						"Unsupported configurable field type");
			}
		} catch (Exception e) {
			throw new DeliveryException(e);
		}
