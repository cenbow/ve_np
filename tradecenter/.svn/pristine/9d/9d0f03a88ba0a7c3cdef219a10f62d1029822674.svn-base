...
public class FilterFactory {
	...
	public static Filter createFilter(FilterDescBean bean) throws TradeException{
	...
	private static void setField(Object instance, Field fd, String value) throws TradeException {
		try {
