...
public interface TradeConstants {
	...
	/*public class OrderStatus{
		...
		public final static int PAID = 2; // 已支付
		public final static int DELIVERY = 3; // 已发货
		public final static int ON_ROAD = 4;// 在途
		public final static int SIGN_OFF = 5;// 签收
	}*/
	...
	public class PaymentStatus{
		public final static int UNPAID = 0;// 待支付
		public final static int PARTIAL_PAID = 1;// 部分支付
		public final static int PAID= 2;// 已支付
	}
	...
	public class SupplierType{
		public final static int VE = 1; // ve 自营
